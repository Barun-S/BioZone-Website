"""
Django settings for bioequipzone project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'category.context_processor.categories_links',
                'institute.context_processor.institute_links',
...
WSGI_APPLICATION = 'bioequipzone.wsgi.application'
